...
def barra_menu(root):
    ...
    menu_inicio.add_command(label ="Crear registro de BD")
...
class Frame(tk.Frame):
    ...
    def campo_pelicula(self):
        ...
        self.entry_duracion.grid(row=1,column=2,padx=10,pady=10,columnspan=2)

        self.mi_genero=tk.StringVar()

        self.entry_genero=tk.Entry(self,textvariable=self.mi_genero)
        self.entry_genero.config(width=50 ,font=("Arial",12))
        self.entry_genero.grid(row=2,column=2,padx=10,pady=10,columnspan=2)
